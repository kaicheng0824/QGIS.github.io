...
def plot_all_node(df,title):
    ...
    plt.savefig("./SDGE_NODE_LMP_Plots/SDGE_NODE_{}_All_Node.png".format(title),bbox_inches="tight")
    plt.close()

def plot_node_prices(df,title,node):
    ...
    creare_folder('./SDGE_NODE_LMP_Plots/{}'.format(node))
    plt.savefig("./SDGE_NODE_LMP_Plots/{}/{}.png".format(node,title))
    plt.close()
